    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 text-white font-sans p-8">
            <div className="mb-12 text-center">
                ...
                <p className="text-xl text-slate-400">{t.home.subtitle}</p>
            </div>
            ...
            <div className="flex gap-8 mb-16">
                ...
                >
                    ...
                    <span className="text-2xl font-bold text-center">
                        {t.home.mainScreen}<br/>
                        <span className="text-sm font-normal opacity-75">{t.home.default}</span>
                    </span>
                </Link>
                ...
                >
                    ...
                    <span className="text-2xl font-bold">{t.home.admin}</span>
                </Link>
            </div>
            ...
            {!isLoading && displays.length > 0 && (
                <div className="flex flex-col items-center w-full max-w-3xl">
                    ...
                    <h2 className="text-xl font-semibold text-slate-400 mb-6">{t.home.otherScreens}</h2>
